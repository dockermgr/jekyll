...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/jekyll"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="jekyll"
INSTDIR="$HOME/.local/share/dockermgr/jekyll"
APPDIR="$HOME/.local/share/srv/docker/jekyll"
DATADIR="$HOME/.local/share/srv/docker/jekyll/files"
...
HUB_URL="casjaysdevdocker/jekyll:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "jekyll"; then
